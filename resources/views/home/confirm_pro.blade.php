...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Công ty cổ phần công nghệ hợp long - hoplong automation</title>
    ...
    <body class="garden-market page-template-template-homepage-v6 woocommerce-active">
        <div id="page" class="hfeed site">
                ...
                <div class="col-full">
                    <ul id="menu-top-bar-left" class="nav justify-content-center">
                        <li class="menu-item animate-dropdown">
                            <a title="TechMarket eCommerce - Always free delivery" href="contact-v1.html">Công ty cổ phần công nghệ hợp long</a>
                        </li>
                        <li class="menu-item animate-dropdown">
                            <a title="Quality Guarantee of products" href="shop.html">Hoplong - Automation</a>
                        </li>
                        <li class="menu-item animate-dropdown">
                            <a title="Fast returnings program" href="track-your-order.html">Chính sách vận chuyển</a>
                        </li>
                    </ul>
                    <!-- .nav -->
                </div>
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Home" href="{{route('home')}}">Trang chủ</a>
                                    </li>
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a title="Sản phẩm" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#">Sản phẩm<span class="caret"></span></a>
                                        
                                        <!-- .dropdown-menu -->
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Logitech Sale" href="product-category.html">Maket</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Headphones Sale" href="product-category.html">Tin tức</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            	...
            	<div class="thumbnail">
            		<img src="{{url('uploads/logo/bghl.jpg')}}" alt="">
            	</div>
            </div>
            <!-- #content -->
