                            ...
                            <main id="main" class="site-main">
                                        ...
                                        <div class="deals-carousel-inner-block">
                                            <header class="section-header">
                                                <h2 class="section-title">
                                                    <strong>Bán chạy nhất</strong> tháng {{date('m',strtotime($date))}}</h2>
                                                                                ...
                                                                                <div class="sale-saved-label">
                                                                                    <span class="saved-label-amount">
                                                                                        <span class="woocommerce-Price-amount amount">
                                                                                            <span class="woocommerce-Price-currencySymbol"></span>SALE</span>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <footer class="section-footer">
                                                <nav class="custom-slick-pagination">
                                                    ...
                                                    <a class="slider-next right" href="#" data-target="#sale-with-timer-carousel .products">Next<i class="tm tm-arrow-right"></i></a>
                                                </nav>
                                            </footer>
                                            <!-- /.section-footer -->
                                        </div>
                                        ...
                                        <div class="section-products-carousel-tabs-wrap">
                                            <header class="section-header">
                                                <ul role="tablist" class="nav justify-content-end">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="#tab-feature" data-toggle="tab">Nổi bật</a>
                                                    </li> -->
                                                </ul>
                                            </header>
                                            <!-- .section-header -->
                                                        ...
                                                        <div class="container-fluid">
                                                            <div class="woocommerce">
                                                                <div class="products">
                                                                    ...
                                                                    <div class="product" style="padding-bottom: 0;">
                                                                        ...
                                                                        <div class="hover-area">
                                                                            ...
                                                                            @if($product->price > 0)
                                                                            <a style="margin-bottom: 1px;margin-top: 5px" class="button add_to_cart_button" href="{{route('add_cart',['id'=>$product->id])}}" rel="dofflow">Thêm giỏ hàng</a>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                    @endforeach
                                ...
                                <section style="background-size: cover; background-position: center center; background-image: url({{url('uploads')}}/banner/back-dien-dan-dung.jpg); height: 853px;" class="section-landscape-full-product-cards-carousel">
                                    <div class="col-full">
                                        <header class="section-header">
                                            <h2 class="section-title">
                                                <strong>Thiết bị điện dân dụng</strong>
                                            </h2>
                                        </header>
                                        <!-- .section-header -->
                                        <div class="row">
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a class="woocommerce-LoopProduct-link " href="https://hoplongtech.com/product-category/schneider-dan-dung">
                                                                                <span class="price">
                                                                                    <ins>
                                                                                        <span class="amount"> Schneider dân dụng</span>
                                                                                    </ins>
                                                                                </span>
                                                                                <!-- .price -->
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a class="woocommerce-LoopProduct-link " href="#">
                                                                                <span class="price">
                                                                                    <ins>
                                                                                        <span class="amount"> LS dân dụng</span>
                                                                                    </ins>
                                                                                </span>
                                                                                <!-- .price -->
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a class="woocommerce-LoopProduct-link " href="#">
                                                                                <span class="price">
                                                                                    <ins>
                                                                                        <span class="amount"> Panasonics Dân dụng</span>
                                                                                    </ins>
                                                                                </span>
                                                                                <!-- .price -->
                                                                                <h2 class="woocommerce-loop-product__title">Công tắc, ổ cắm, phích cắm, cầu dao bảo vệ,...</h2>
                                                                    ...
                                                                    <div class="media">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <a class="woocommerce-LoopProduct-link " href="#">
                                                                                <span class="price">
                                                                                    <ins>
                                                                                        <span class="amount"> Điện dân dụng</span>
                                                                                    </ins>
                                                                                </span>
                                                                                <!-- .price -->
                                                                                <h2 class="woocommerce-loop-product__title">Công tắc, ổ cắm, phích cắm, cầu dao bảo vệ,...</h2>
                                        ...
                                        <div class="banner banner-short text-in-left">
                                            <a href="shop.html">
                                                <div style="background-size: cover; background-position: center center; background-image: url( {{url('uploads')}}/banner/banner-schneider-2.jpg ); height: 259px;" class="banner-bg">
                                                    <div class="caption">
                                                        <div class="banner-info">
                                                            <h3 class="title" style="color: #30AB40 !important;">
                                                                 Chuyên trang<br>
                                                                <strong>Schneider</br>Electric</strong></h3>
                                                        </div>
                                ...
                                <section class="stretch-full-width section-products-carousel-with-vertical-tabs">
                                    <header class="section-header">
                                        <h3 class="section-title">
                                            <strong>Nhà phân phối chính thức</strong></h3>
                                    </header>
                                        ...
                                        <ul role="tablist" class="nav">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#top-1" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-desktop-pc"></i> Schneider</span>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-2" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-laptop"></i> Omron</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-3" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-smartphone"></i> Autonics</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-4" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-digital-camera"></i> Idec</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-5" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-accesories"></i> Mitsubishi</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-6" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-accesories"></i> LS</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-8" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-accesories"></i> Hanyoung</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="#top-8" data-toggle="tab">
                                                    <span class="category-title">
                                                        <i class="tm tm-accesories"></i> Delta</span>
                                                    <i class="tm tm-arrow-right"></i>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="item">
                                                <a href="{{$partner->slug}}">
                                                    <figure>
                                                        ...
                                                        <img width="145" height="50" class="img-responsive desaturate" alt="{{$partner->title}}" src="{{url('uploads/partner')}}/{{$partner->cover_image}}">
                                                    </figure>
                                                </a>
                                            </div>
                                            @endforeach
