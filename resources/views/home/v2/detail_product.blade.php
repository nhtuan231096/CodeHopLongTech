...
@section('mainContainer')
    ...
    <div class="main-container container">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{route('view_category',['slug'=>$product->category->slug])}}">{{$product->category->title}}</a>
            </li>
            <li>{{$product->title}}</li>
        </ul>
        <div class="row">
                        ...
                        <div class="box-category">
                            <ul id="cat_accordion" class="list-group">
                                @foreach($cate as $category)
                                    <li class="hadchild"><a href="{{route('view_category',[$category->slug])}}"
                                                            class="cutom-parent">{{$category->title}}</a>
                                        ...
                                        <div class="product-layout item-inner style1 ">
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="{{route('view',['slug'=>$promotion->slug])}}"
                                                       target="_self" title="{{$promotion->title}}">
                                                        <?php $urlImage = ($promotion->pdp == 1) ? 'uploads/product_new/cover_image' : 'uploads/product'?>
                                                        <img src="{{url($urlImage)}}/{{$promotion->cover_image}}"
                                                             alt="{{$promotion->cover_image}}">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="item-info">
                                                <div class="item-title">
                                                    <a href="{{route('view',['slug'=>$promotion->slug])}}"
                                                       target="_self"
                                                       title="{{$promotion->title}}">{{$promotion->title}}</a>
                                                </div>
                                                <div class="rating">
                                                ...
                                                <div class="content_price price">
                                                    <span
                                                        class="price-new product-price">{{$cart->PriceProduct($promotion)}}</span>&nbsp;&nbsp;
                                                </div>
                                            </div>
                                            <!-- End item-info -->
                                            <!-- End item-wrap-inner -->
                    ...
                    <div class="banner-sidebar banners">
                        <div>
                            <a title="Banner Image" href="#">
                                <img src="{{url('public/homev2')}}/image/catalog/banners/banner-sidebar.jpg"
                                     alt="Banner Image">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="left-content-product">
                        ...
                        <div class="content-product-left class-honizol col-md-5 col-sm-12 col-xs-12">
                            <div class="large-image  ">
                                ...
                                <img itemprop="image" class="product-image-zoom"
                                     src="{{url($urlImage)}}/{{$product->cover_image}}" title="" alt="">
                            </div>
                            @if(isset($product->video))
                                <a class="thumb-video pull-left" href="{{$product->video}}"><i
                            ...
                            <div class="modal-dialog" style="max-width: 678px">
                                ...
                                <div class="modal-content text-center">
                                    ...
                                    <div class="modal-body">
                                        <iframe style="margin-bottom: 66px" src="{{$product->image_360}}" scrolling="no"
                                                frameborder="0" width=560 height=315 allowfullscreen
                                                data-token="k6f7rb"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="content-product-right col-md-7 col-sm-12 col-xs-12">
                            ...
                            @if($product->in_stock > 0)
                                <div class="alert alert-success" style="background: #288d45;">
                                    <i class="fa fa-check" style="color:#fff;"></i>
                                    <strong style="color:#fff;font-size: 15px;">{{$product->in_stock}} sản phẩm trong
                                        kho và sẵn sàng giao trong 4 ngày làm việc</strong>
                                </div>
                            @else
                                <div class="alert alert-danger" style="font-size: 15px;">
                                    <i class="fa fa-exclamation-triangle"></i>
                                    <strong>Tình trạng:</strong> không có sẵn
                                </div>
                            @endif
                            ...
                            <div class="box-review form-group">
                                ...
                                <a class="reviews_button" href=""
                                   onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;">{{$product->countRate->count()}}
                                    đánh giá</a> |
                                <a class="write_review_button" href=""
                                   onclick="$('a[href=\'#danh-gia\']').trigger('click'); return false;">Đánh giá sản
                                    phẩm này</a>
                            </div>
                                ...
                                <div class="product_page_price price" itemprop="offerDetails" itemscope=""
                                    ...
                                    @if($flashsale == 1)
                                        <span class="price-new"
                                              itemprop="price">{{number_format($dataProduct->price)}}</span>
                                    @else
                                        <span class="price-new"
                                              itemprop="price">{{$cart->PriceProduct($product)}}</span>
                                    @endif
                                    <span
                                        class="price-old">{{$product->list_price > 0 ? number_format($product->list_price) : ''}}</span>
                                </div>
                                {{--                    @if($product->in_stock > 0)--}}
                            ...
                            <div class="product-box-desc">
                                <div class="inner-box-desc">
                                    ...
                                    <div class="brand"><span>Danh mục:</span><a
                                            href="{{route('view_category',['slug'=>$product->category->slug])}}">   {{$product->category->title}}</a>
                                    </div>
                            ...
                            @else
                                                    ...
                                                    <a href="{{route('document',['slug'=>$product->slug])}}"><img
                                                            src="{{url('uploads/download')}}/icon-download-9.png"
                                                            title="{{$product->taiLieu->title}}"
                            ...
                            <div id="product">
                                <div class="woocommerce-product-details__short-description"
                                     style="padding-bottom: 25px;margin-bottom:15px;border-bottom: 1px solid #eee">
                                    <ins>
                                        <b>DỊCH VỤ & KHUYẾN MẠI</b>
                                    </ins>
                                    <ul>
                                        <li>Quà tặng trị giá <b style="color: red">200.000đ</b> (Áp dụng sản phẩm tự
                                            động hóa công nghiệp <b style="color:#2A9332">SCHNEIDER ELECTRIC</b>)
                                        </li>
                                        <li>Nhập mã <b style="color: red">HOPLONG</b> giảm thêm 1% dành cho toàn bộ đơn
                                            hàng từ <b style="color: red">01/01 đến 20/04/2020</b></li>
                                        <li>Tặng <b style="color: red">voucher 20.000đ khi đánh giá 5*</b> (Áp dụng cho
                                ...
                                <form enctype="multipart/form-data" action="{{route('shopNow')}}" method="post"
                                      class="cart">
                                    @csrf
                                        ...
                                        <div class="form-group box-info-product">
                                            ...
                                            @if($flashsale == 1)
                                                ...
                                                <input type="hidden" name="flash_sale_id"
                                                       value="{{$dataProduct->flash_sale_id}}">
                                            @endif
                                            <div class="cart">
                                                <button class="btn btn-primary btn-lg" name="addCart" value="true"
                                                        style="font-weight: bold; font-size: 16px;">
                                                    <i style="margin-right: 5px" class="fa fa-shopping-cart"></i>Thêm
                                                    giỏ hàng
                                                </button>
                                            </div>
                                            <div class="add-to-links wish_comp wishlist">
                                                <button class="btn btn-danger btn-lg" name="shopNow" value="true"
                                                        style="font-weight: bold; font-size: 16px;">
                                                    <i style="margin-right: 5px" class="fa fa-money"></i>Mua ngay
                                                </button>
                                            </div>
                                            <a data-toggle="modal" href='#modal-id' style="font-size: 14px;text-decoration: underline;"
                                               onclick="formCheckStock()">Kiểm tra tồn kho thực tế</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h2 class="modal-title">Kiểm tra tồn kho thực tế</h2>
                                                        </div>
                                                        <div class="modal-body">
                                                            <p>Nhập số lượng bạn muốn kiểm tra cho sản phẩm:
                                                            ...
                                                            <form action="" method="POST" class="form-inline"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <button type="button" class="btn btn-primary" id="check-stock"
                                                                                onclick="checkStock({{$product->id}})">Check
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                        <div class="modal-footer modal-footer-check-stock">
                                    ...
                                    @else
                                        <a class="btn btn-danger fa fa-money" data-toggle="modal" href='#modal-id'
                                           style="font-weight: bold; padding: 18px 20px; font-size: 18px; width: 50%;color:#fff"><span> Yêu cầu báo giá</span></a>
                                    @endif
                                </form>
                    ...
                    <div class="col-md-12">
                        <div class="panel-body table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <tr dir-paginate="itemPartNumber in getPartNumber | itemsPerPage: 5"
                                    ...
                                    <td class="verticalMid">
                                        <div>
                                            ...
                                            <!-- <a class="pull-left" href="{{route('view',[$product->slug])}}"> -->
                                                <a class="pull-left"
                                                   href="{{url('')}}/products/@{{itemPartNumber['slug']}}">
                                                    <img ng-if="itemPartNumber['pdp'] == 1" width="70px"
                                                         class="media-object"
                                                         src="{{url('uploads/product_new/cover_image/')}}/@{{itemPartNumber['cover_image']}}"
                                                         alt="Image">
                                                    <img ng-if="itemPartNumber['pdp'] == 0" width="70px"
                                                         class="media-object"
                                                         src="{{url('uploads/product/')}}/@{{itemPartNumber['cover_image']}}"
                                                         alt="Image">
                                                </a>
                                                <div class="media-body" style="padding-left: 15px">
                                                    <h3 class="media-heading" style="font-size: 15px"><a
                                                            href="{{url('')}}/products/@{{itemPartNumber['slug']}}">@{{itemPartNumber['title']}}</a>
                                                    </h3>
  ...
  <span class="woocommerce-Price-amount amount">
      <span>
        @{{itemPartNumber['price']}}
                                    ...
                                    <td class="verticalMid" style="width: 160px">
                                        <p>Có sẵn: @{{itemPartNumber['in_stock'] > 0 ? itemPartNumber['in_stock'] :
                                            0}}</p>
                                    ...
                                    <td class="verticalMid" ng-if="itemPartNumber['price']!='Liên hệ 1900.6536'">
                                        <a href="" ng-click="addCart(itemPartNumber['id'],quantity)"
                                           class="btn btn-md btn-info"
                                           style="margin-bottom: 5px;    padding-right: 20px;">
                                            <i class="fa fa-shopping-cart"></i> Thêm giỏ
                                        </a>
                                        <div class="clearfix"></div>
                                        <a href="" ng-click="shopNow(itemPartNumber['id'],quantity)"
                                ...
                                <div class="position_anchor" style="position: absolute; bottom: 60px"
                                     id="specifications"></div>
                            </table>
            ...
            <p>{!!$product->taiLieu->content!!}</p>
                                ...
                                <div id="danh-gia">
                                    ...
                                    <form action="{{route('rateProduct')}}" method="POST" role="form"
                                            ...
                                            <div class="col-md-3">
                                                <div class="advanced-review row">
                                                    <div class="advanced-review-rating">
                                                        <h2 class="based-title" style="margin-bottom: 20px">Đánh
                                                            giá {{$product->title}}</h2>
                                                        <div class="avg-rating">
                                                            <span class="avg-rating-number"
                                                                  style="font-size: 23px; margin-top: 15px; float: left;">{{number_format($percentRated,1)}}</span>
                                                            <div class="star-rating"
                                                                 style="font-size: 1.8em;margin:15px 25px;"
                                                                 title="Rated 0.0 out of 5">
                                                                <span
                                                                    style="width:{{$countRates > 0 ? (100/5 * $percentRated) : 100 }}%"></span>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="rating-histogram" style="width: 100%">
                                                            <div class="rating-bar" style="position: relative;">
                                                                <div class="star-rating"
                                                                     style="margin-right:10px;font-size: 1.6em"
                                                                     title="Rated 5 out of 5">
                                                                    <span style="width:100%"></span>
                                                                </div>
                                                                <div class="rating-count zero">{{$countRate5}}</div>
                                                                <div class="rating-percentage-bar"
                                                                     style="position:absolute;top:7px;right:0;width: 12.25em;height: 0.625em;border-radius: 0.313em;background-color: #f3f3f3;">
                                                                    <span
                                                                        style="width:{{$countRate5 > 0 ? 100/($countRates/$countRate5) : 0}}%"
                                                                        class="rating-percentage"
                                                                        style="height: 100%;background-color: #59abe1; display: block;"></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-bar" style="position: relative;">
                                                                <div class="star-rating"
                                                                ...
                                                                <div class="rating-percentage-bar"
                                                                     style="position:absolute;top:7px;right:0;width: 12.25em;height: 0.625em;border-radius: 0.313em;background-color: #f3f3f3;">
                                                                    <span
                                                                        style="width:{{$countRate4 > 0 ? 100/($countRates/$countRate4) : 0}}%"
                                                                        class="rating-percentage"
                                                                        style="height: 100%;background-color: #59abe1; display: block;"></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-bar" style="position: relative;">
                                                                ...
                                                                <div class="rating-percentage-bar"
                                                                     style="position:absolute;top:7px;right:0;width: 12.25em;height: 0.625em;border-radius: 0.313em;background-color: #f3f3f3;">
                                                                    <span
                                                                        style="width:{{$countRate3 > 0 ? 100/($countRates/$countRate3) : 0}}%"
                                                                        class="rating-percentage"
                                                                        style="height: 100%;background-color: #59abe1; display: block;"></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-bar" style="position: relative;">
                                                                ...
                                                                <div class="rating-percentage-bar"
                                                                     style="position:absolute;top:7px;right:0;width: 12.25em;height: 0.625em;border-radius: 0.313em;background-color: #f3f3f3;">
                                                                    <span
                                                                        style="width:{{$countRate2 > 0 ? 100/($countRates/$countRate2) : 0}}%"
                                                                        class="rating-percentage"
                                                                        style="height: 100%;background-color: #59abe1; display: block;"></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-bar" style="position: relative;">
                                                                ...
                                                                <div class="rating-percentage-bar"
                                                                     style="position:absolute;top:7px;right:0;width: 12.25em;height: 0.625em;border-radius: 0.313em;background-color: #f3f3f3;">
                                                                    <span
                                                                        style="width:{{$countRate1 > 0 ? 100/($countRates/$countRate1) : 0}}%"
                                                                        class="rating-percentage"
                                                                        style="height: 100%;background-color: #59abe1; display: block;"></span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="contacts-form">
                                                    ...
                                                    <div class="form-group"><span class="icon icon-bubbles-2"></span>
                                                        <textarea class="form-control" name="content"
                                                                  placeholder="Nội dung đánh giá của bạn về sản phẩm.."></textarea>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div id="review" class="col-md-12">
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    @foreach($rates as $rate)
                                                        <tr>
                                                            <td style="width: 50%;"><strong>{{$rate->name}}</strong>
                                                            </td>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="comments-container" style="width: 100%">
                                            <form action="{{route('comment')}}" method="POST" role="form"
                                                ...
                                                <div class="form-group">
                                                    <textarea name="comment" id="desc" class="form-control" rows="3"
                                                    ...
                                                    <div class="comment-main-level">
                                                        ...
                                                        <div class="comment-box">
                                                            <div class="comment-head">
                                                                <h6 class="comment-name by-author"><i
                                                                        class="fa fa-user"></i> @{{commentItem['name']}}
                                                                </h6>
                                                                <!-- <span>@{{commentItem['created_at']}}</span> -->
                                                                <i class="fa fa-reply"
                                                                   ng-click="replyComment(commentItem['id'])">
                                                                    <!-- @{{commentItem['reply']}} thảo luận --></i>
                                                                <!-- <i class="fa fa-heart"></i> -->
                                                            </div>
                                                            <div class="comment-content">
                                                                @{{commentItem['comment']}}
                                                            </div>
                                                            <img ng-if="commentItem['cover_image']"
                                                                 style="margin-left: 20px; max-height: 200px"
                                                                 src="{{url('uploads/comment')}}/@{{commentItem['cover_image']}}"
                                                                 alt="">
                                                            <div class="col">
                  <span class="fa fa-reply" ng-click="replyComment(commentItem['id'])"
                        style="cursor: pointer;font-size: 14px;color:#3498db">
                                                    ...
                                                    <ul class="comments-list reply-comment reply-list hide">
                                                        <li ng-repeat="itemReply in getReplyCommentProduct">
                                                            <div class="comment-avatar" style="margin-left: 26px">
                                                                <img ng-if="itemReply['name']"
                                                                     src="https://icon-library.net/images/windows-8-user-icon/windows-8-user-icon-10.jpg"
                                                                     alt="">
                                                                <img ng-if="itemReply['name'] == null"
                                                                     src="https://hoplongtech.com/uploads/logo/favicon.png">
                                                            </div>
                                                            <div class="comment-box">
                                                                <div class="comment-head">
                                                                    <h6 ng-if="itemReply['name']" class="comment-name">
                                                                        <a href="">@{{itemReply['name']}}</a></h6>
                                                                    <h6 ng-if="!itemReply['name']" class="comment-name">
                                                                        <a href="">Quản trị viên</a></h6>
                                                        ...
                                                        <li>
                                                            <form action="{{route('comment')}}" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <input type="hidden" name="id_comment_reply"
                                                                           value="@{{commentItem['id']}}">
                                                                    <input type="hidden" name="product_id"
                                                                           value="@{{commentItem['product_id']}}">
                                                                </div>
                                                                <button type="submit"
                                                                        class="pull-right btn btn-primary">Gửi
                                                                </button>
                                                            </form>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block left-b">
                                            <div class="product-image-container">
                                                <a href="{{route('view',['slug'=>$other->slug])}}" target="_self"
                                                   title="{{$other->title}}">
                                                    <?php $urlImage = ($other->pdp == 1) ? 'uploads/product_new/cover_image' : 'uploads/product'?>
                                                    <img src="{{url($urlImage)}}/{{$other->cover_image}}"
                          ...
                          @if($other->price > 0)
                            ...
                            @endif
                                            ...
                                            <div class="caption hide-cont">
                                                ...
                                                <h4><a href="{{route('view',['slug'=>$other->slug])}}"
                                                       title="Pastrami bacon" target="_self">{{$other->title}}</a></h4>
                                            </div>
                                            <p class="price">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">
                                    <span ng-hide="language"
                                          style="color: red">Yêu cầu nhanh qua hotline: 1900.6536</span>
          ...
          <span ng-hide="language">Bạn đang yêu cầu báo giá sản phẩm {{$product->title}} </br>
              Nhập đầy đủ thông tin dưới đây để chúng tôi hỗ trợ bạn.</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input ng-hide="language" ng-model="KHACH_HANG" type="text" name="name"
                                               class="form-control" id="" required placeholder="Nhập họ tên">
                                        <input ng-show="language" ng-model="KHACH_HANG" type="text" name="name"
                                               class="form-control" id="" required placeholder="Enter your name">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="">Email:</label>
                                        <input ng-hide="language" ng-model="EMAIL" type="email" name="email"
                                               class="form-control" id="" required placeholder="Nhập email">
                                        <input ng-show="language" ng-model="EMAIL" type="email" name="email"
                                               class="form-control" id="" required placeholder="Enter email">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input ng-model="SAN_PHAM" type="hidden" name="product" class="form-control"
                                               id="SAN_PHAM" value="{{$product->title}}">
                                    </div>
                                    <input ng-model="MA_SAN_PHAM" type="hidden" name="code_product" class="form-control"
                                           id="MA_SAN_PHAM" value="{{$product->slug}}">
                                    <div class="form-group">
                                        <label class="control-label" for="">
                                            <span ng-hide="language">Số điện thoại:*</span>
                                            <span ng-show="language">Phone number:*</span>
                                        </label>
                                        <input ng-hide="language" ng-model="SO_DIEN_THOAI" type="number" name="phone"
                                               class="form-control" id="" required placeholder="Nhập số điện thoại">
                                        <input ng-show="language" ng-model="SO_DIEN_THOAI" type="number" name="phone"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select ng-model="DIA_CHI" ng-hide="language" id="DIA_CHI" name="diaChi"
                                        ...
                                        <select ng-model="DIA_CHI" ng-show="language" name="diaChi" id="input"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea ng-hide="language" ng-model="NOI_DUNG" name="content"
                                                  class="form-control" rows=8 placeholder="Nội dung.."></textarea>
                                        <textarea ng-show="language" ng-model="NOI_DUNG" name="content"
                                                  class="form-control" rows=8 placeholder="Enter content.."></textarea>
                                    </div>@csrf
                                    <div class="form-group text-right">
                                        ...
                                        <button ng-hide="language" type="button" class="btn btn-info"
                                                data-dismiss="modal">Đóng
                                        </button>
                                        <button ng-show="language" type="button" class="btn btn-info"
...
{{--    </div>--}}
    ...
    <script type="text/javascript">
        ...
        function formCheckStock() {
            var qty = $("#quantity-input").val();
            $("#qtyCheckStock").val(qty);
        }

        function checkStock(product_id){
            var qty = $("#qtyCheckStock").val();
            $("#check-stock").addClass("loader");
            // var url = window.location.protocol + "//" + window.location.hostname;
            var url = window.location.protocol + "//" + window.location.hostname + "/CodeHopLongTech";
            $.ajax({
                type: "GET",
                dataType: "json",
                url: url + "/api/checkStock?product_id=" + product_id + "&qty=" + qty,
                success: function (data) {
                    if (data['in_stock'] > qty) {
                        var html = '<div class="text-left" style="font-size: 15px;"> <i class="fa fa-check"></i> Có sẵn ' + qty + ' sản phẩm trong kho</div>';
                        $(".modal-footer-check-stock").html(html);
                        $("#check-stock").removeClass("loader");
                    }
                    if (data['in_stock'] < qty) {
                        var html = '<div class="text-left" style="font-size: 15px; color:red;"> <i class="fa fa-exclamation-triangle"></i> Có sẵn ' + data['in_stock'] + ' sản phẩm trong kho, ' + (qty - data['in_stock']) + ' sản phẩm tạm thời hết hàng và sẽ có hàng trong 7 ngày';
                        $(".modal-footer-check-stock").html(html);
                        $("#check-stock").removeClass("loader");
                    }
                },
