...
<!-- //--- -->
        ...
        $http.get(url+'/CodeHopLongTech/api/getRateProduct/' + product_id).then(function(res){
          $scope.getRateProduct = res.data;
        });
        $http.get(url+'/CodeHopLongTech/api/getCommentProduct/' + product_id).then(function(res){
          $scope.getCommentProduct = res.data;
        }); 
        $scope.replyComment = function(idComment){
          $http.get(url+'/CodeHopLongTech/api/getReplyCommentProduct/' + idComment).then(function(res){
        ...
        // get partnumber
        $http.get(url+'/CodeHopLongTech/api/getPartNumber/' + product_id).then(function(res){
        ...
        $scope.addCart = function(idProduct,quantity){
          $http.get(url+'/CodeHopLongTech/cart/add-to-cart/' + idProduct + '/' + quantity).then(function(res){
            alert('Đã thêm sản phẩm vào giỏ hàng');
            location.reload();
          });
        }
        $scope.shopNow = function(idProduct,quantity){
          $http.get(url+'/CodeHopLongTech/cart/shop-now/' + idProduct + '/' + quantity).then(function(res){
