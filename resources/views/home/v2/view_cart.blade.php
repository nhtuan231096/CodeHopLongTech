		...
		<form class="woocommerce-cart-form" action="{{route('usesCoupon')}}" method="post">
			...
			<div class="panel-group" id="accordion">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a href="#collapse-shipping" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" aria-expanded="false">Danh sách mã giảm giá
								<i class="fa fa-caret-down"></i>
							</a>
						</h4>
					</div>
							...
							<div class="form-horizontal">
								<ul class="list-group">
								  ...
								  <li class="list-group-item">
								  	{{$itemCoupon->rule->name}}
									<span>: <b>{{$itemCoupon->coupon_code}}</b></span>
								  	<br>
								  	<span style="font-size: 10px;font-style: italic;">HSD: {{$itemCoupon->rule->to_date}}</span>
								  </li>
								  @endforeach
								</ul>
							</div>
