            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    <nav class="woocommerce-breadcrumb">
                        ...
                        <span class="delimiter"><i class="fa fa-angle-right"></i></span>Download
                    </nav>
                    <div class="homev6-slider-with-banners row">
                        <div class="slider-block column-1">
                            <h3 style="color: red; padding: 10px;">DOWNLOAD</h3>
                                            ...
                                            <div class="products">
                                                ...
                                                <div class="product" > 
                                                    ...
                                                    'slug'=>$cata->slug])}}" class="woocommerce-LoopProduct-link" rel="dofollow">
                                                        ...
                                                        @endif
                                                        <span class="price"><ins><span class="amount"> </span></ins><span class="amount">{{$cata->title}}</span></span><h2 class="woocommerce-loop-product__title"></h2>
                                                    </a>
                                                </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="products">                                                         
                                                ...
                                                <div class="product"> 
                                                    <a href="{{route('view_doc',['slug'=>$price->slug])}}" class="woocommerce-LoopProduct-link" rel="dofollow">
                                                        ...
                                                        @endif     
                                                        <span class="price">
                                                            <ins><span class="amount"> </span></ins><span class="amount">{{$price->title}}</span>
                                                        </span>
                                        ...
                                        <div class="woocommerce">
                                            <div class="products">
                                                ...
                                                <div class="product"> 
                                                    ...
                                                    @endif
                                                    <span class="price">
                                                        <ins><span class="amount"> </span></ins><span class="amount">{{$manua->title}}</span>
                                                    </span>
