                                ...
                                <article class="post format-image">
                                    <div class="media-attachment">
                                        <div class="post-thumbnail">
                                            <img width="1433" height="250px" alt="" class="wp-post-image img-project" src="{{url('uploads/news')}}/{{$news_dt->image_cover}}">
                                        </div>
                                    </div>
                                    <header class="entry-header">
                                        <h1 class="entry-title">{{$news_dt->title}}
                                        ...
                                        <div class="entry-meta">
                                            ...
                                            <span class="posted-on">
                                                <a rel="bookmark" href="#">
                                                    <time datetime="2017-03-23T08:06:09+00:00" class="entry-date published">{{$news_dt->created_at}}</time>
                                                </a>
                                            </span>
                                            <!-- .posted-on -->
                                            <span class="author">
                                                <a rel="author" title="Posts by Jane Smith" href="#">By {{$news_dt->created_by}}</a>
                                            </span>
                                            <!-- .author -->
                                        </div>
                                        <!-- .entry-meta -->
