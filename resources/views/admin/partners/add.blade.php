	...
	<div class="panel-body">
		<form action="" method="POST" role="form" enctype="multipart/form-data">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="title" id="name" value="{{old('title')}}" placeholder="Nhập tên hãng">
				@if($errors->has('title'))
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="link" id="" value="{{old('link')}}" placeholder="Nhập đường dẫn liên kết">
				@if($errors->has('link'))
					<div class="help-block error">
						{{$errors->first('link')}}
					</div>
