                ...
                <td>
                    ...
                    <span style="margin-right: 31px">
                        ...
                        @if($order->payment_status == 1)
                            @if($order->payment_method == "Thanh toán qua Momo")
                                <strong>(Đã thanh toán qua Momo)</strong>
                            @elseif($order->payment_method == "Thanh toán qua VNPay")
                                <strong>(Đã thanh toán qua VNPay)</strong>
                            @endif
                        @endif
                  </span>
                </td>
