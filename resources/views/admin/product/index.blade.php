                                  ...
                                  <div class="tab-content">
                                      <div id="home" class="tab-pane fade in active">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input name="price_when_login" class="form-control" placeholder="Giá khi khách hàng đăng nhập">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="download_id">ID tải về:</label>
                                            <select name="download_id" id="" class="form-control" data-error="Bạn chưa tài liệu." required>
                                                <option value="">Chọn tài liệu</option>
                                                @foreach($downs as $down)
                                                <option value="{{$down->id}}">{{$down->title}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="">Sản phẩm mới</label>
                                            <!-- <select name="" id="input" class="form-control" required="required">
                                                <option value="">Sản phẩm mới</option>
                                            </select> -->
                                            <div class="clearfix"></div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label" for="">Sản phẩm đặc biệt</label>
                                            <!-- <select name="" id="input" class="form-control" required="required">
                                                <option value="">Sản phẩm mới</option>
                                            </select> -->
                                            <div class="clearfix"></div>
