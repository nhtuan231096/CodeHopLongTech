	...
	<form action="" method="POST" role="form" enctype="multipart/form-data">
		...
		<br>
	    	...
	    	<div class="form-group">
	    		...
	    		<textarea name="meta_description"  class="form-control" placeholder="meta_description">{{$cate->meta_description}}</textarea>
	    	</div>
	    	<div class="form-group">
		...
		<!-- 	<div class="form-group">
			...
			<div class="form-group">
	    		...
	    		<textarea name="content"  class="form-control" placeholder="Nội dung">{{$cate->content}}</textarea>
	    	</div>
	   ...
	   <div class="modal-footer">
	     ...
	     <a href="{{route('list-cat-1')}}" class="btn btn-danger" data-dismiss="modal">Hủy</a>
	   </div>
