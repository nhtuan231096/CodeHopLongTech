      ...
      <div id="primary" class="content-area">
        ...
        <main id="main" class="site-main">
          <div class="product product-type-simple">
                      ...
                      <figure class="woocommerce-product-gallery__wrapper ">
                        <div data-thumb="assets/images/products/sm-card-3.jpg" class="woocommerce-product-gallery__image">
                          ...
                          <div class="w3-bar w3-black">
                            <button class="w3-bar-item w3-button rm-background" onclick="openCity('VideoProductDetail')" style="padding-left: 0px">
                              @if(isset($product->video))
                              <a class="text-center" target="_blank" style="width: 69px;display: inline-block; float: left;" href="">
                               <img style="width: 66px;margin-left: 10px;display: inline-block;" src="{{url('public/home')}}/assets/images/video.png" alt="Video">
                             </a>
                             @endif
                           </button>
                          ...
                          <button class="w3-bar-item w3-button rm-background" onclick="openCity('imageProductDetail')">
                            ...
                            <a class="text-center" style="width: 86px;display: inline-block;float: left;" data-toggle="modal" href='#image_360'>
                              <img style="width: 66px;margin-left: 10px" src="{{url('public/home')}}/assets/images/360.png" alt="">
                            </a>  
                            @endif
                          </button>
                        </div>
                                ...
                                <div class="product-actions">
                                  ...
                                  <div>
                                    <form enctype="multipart/form-data" action="{{route('shopNow')}}" method="post" class="cart"> 
                                      ...
                                      <button class="btn btn-primary" name="addCart" value="true" style="font-weight: bold; padding: 13.6px 20px; font-size: 18px; width: 100%"> <i style="margin-right: 5px" class="fa fa-shopping-cart"></i>Thêm giỏ hàng</button>&nbsp; &nbsp; &nbsp;
                                    ...
                                    <div>
                                      <div class="media">
                                        ...
                                        <div class="media-body" style="padding-left: 15px">
                                          <h4 class="media-heading" style="font-size: 15px">@{{itemPartNumber['title']}}</h4>
                                          <p>
            ...
            <input type="text" class="AuthCheck" value="true">
            <input type="text" class="Discount" value="{{$cart->DiscountAmount()}}">
            @endif
            <!-- // PDP -->
          </div>
          <!-- .col-full -->
